...
from datamodel.base_models import Size
...
class DoclingParseV4PageBackend(PdfPageBackend):
    ...
    def _ensure_parsed(self) -> None:
        ...
        # Appeler get_page sans arguments non supportés
        seg_page = self._dp_doc.get_page(self._page_no + 1)

        # Convertir tous les TextCell en top-left origin
